...
$('#id_transaction_type').selectize(
    {
        ...
        onChange: function (e) {
            ...
            loadOptions(mainURL + `/currency-allocation/undertaking-json-list/`, 'id_undertaking')(e)
        }
...
$('#id_undertaking').selectize(
    {
        ...
        onChange: function (e) {
            ...
            deleteSelectizeOption('id_currency_rate');
            deleteSelectizeOption('id_request_type');
            loadOptions(mainURL + `/currency-allocation/facility-location-json-list/`, 'id_facility_location')(e);
        }
...
$('#id_facility_location').selectize(
    {
        ...
        onChange: function (e) {
            ...
            deleteSelectizeOption('id_currency_rate');
            deleteSelectizeOption('id_request_type');
            loadOptions(mainURL + `/currency-allocation/repayment-deadline-json-list/`, 'id_repayment_deadline')(e);
        }
...
$('#id_repayment_deadline').selectize(
    {
        ...
        onChange: function (e) {
            ...
            deleteSelectizeOption('id_currency_rate');
            deleteSelectizeOption('id_request_type');
            loadOptions(mainURL + `/currency-allocation/supply-currency-place-json-list/`, 'id_supply_currency_place')(e);
        }
...
$('#id_supply_currency_place').selectize(
    {
        ...
        onChange: function (e) {
            deleteSelectizeOption('id_currency_rate');
            deleteSelectizeOption('id_request_type');
            loadOptions(mainURL + `/currency-allocation/currency-rate-json-list/`, 'id_currency_rate')(e);
        }
    }
);
...
$('#id_currency_rate').selectize(
    {
        ...
        onChange: function (e) {
            deleteSelectizeOption('id_request_type');
            loadOptions(mainURL + `/currency-allocation/request-type-json-list/`, 'id_request_type')(e);
        }
